...
public class Recognizer {
	...
	public Recognizer(Context context, String pFilePathWav, int typeMode, int typeFrequencies, boolean showDBG) throws IOException, WavFileException {
		...
		// Generate TMP paths
		File file = new File(context.getCacheDir(), "resampled_tmpSignalID.wav");
		tmpResampledFilePath = file.getAbsolutePath();

		file = new File(context.getCacheDir(), "split_tmpSignalID.wav");
